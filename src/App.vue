...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <p v-else class="text-2xl font-extrabold text-gray-500 text-center">Añade una <span class="text-indigo-600">cantidad</span>  y un <span class="text-indigo-600">plazo</span>  a Pagar</p>
  </div>
</template>
